...
if(!(id in c.inv.stack)&&Object.keys(c.inv.stack).length>=STACK_CAP)return false;
...
#wd .qiĘĐȷďĒőĄĚˡėĎЫ3ĈăƄ.r1,ĈĀČ2ĉĀČ3{ĻĠһĔāҾďāȐēċӏĄĉӕēćɍĎĀѡċĀǓĩĚɫćĊċĈĀȇġĀŀdfe6e4,#8fa39dċĀŀ3ĢĀŀ9a274,#96603aĉĆйeaderboard podiumćĒŁodiuđĆʂąđӁpxČāȪČāŋĄĀŏsvgėĄ˺ĄĀʮĉăǕodsĘĀ҅Ėāщflex-end;gap:ĈđȗodąėѿďăӺĈĆҾ;ĊĂʡ2ćąӁright:2%ĈĀŏčĤȭ.3%ĈăӇ.pin{ĉČ˹ğăҼ1)đćЃĒĢӢąĀš .rowĔąƼpod .slĊĖлąāģ7Ĉāģ7čēˋ 3ėāĵĪėр25ĎāŝēāІąăЍćĒčod.p1 .slİāřĎģǖćģƱĉĐũċĀŬ2ĥĀŬcfe3dc,#7fa79bĊĀŃ3ĥĀŃd99a6a,#8d57ćěѪpod .pnĠĘƩ3ģęǨ06ĐġĒtext-ĆĀĔellipsisĐĚɽČČƔ1ĄĂǌrgba(6,10,20,.95),ąĜщČĀęċĀǖĊĆŉēĘҶĤĀůķĀǑČĀќąĀɪĐĐĚf3d4ĊĀƾĊĞɬ0ČĀƾpaperĈđǃ9ĈĉЇvipbčĀĻćĉʾ5Ęăŕ5)}#wd .vtĈĄҾlapse:ąĀĈčĆĜĈĝҦĄĀĺ th,ĆĀĊdĊĔǸĈāǥĚěДďāаĕąǟvt td:firąĆіćĀźhĉĀĖ{čĆ˪ċĀŐrmalĆĀŐ.curĔĒǒĄđŨ07ċąӵbolĄĤќvĆĔɕĈģ˃ČĀĩċĆѦąĉʑ2b84a}#wdĄěӝĕĜӪ6ćġњ6px}#wd .name.vip4{ěčǕ54,60,.7)ċĀĶ9ćčűd70ďčȚ6px ĄĀě,ČĤЂ55,215ĐĐğshineėĤҎ alternačĤҘshine{fromĎĀǊ4čĀƅ0ĐĀƅ4)}toĎĀĺ10px #fff3a0,ąĤōĎĀĻ9)}}@media(prefers-reduced-moĄĂ҉duceĄĉɗćĀȽćĀǷnone}}ĈĄşmon.auraĒĥũ5ĐĀƄćāƂ trĴĀ҉ĆăŤreward revąĜӾwd .rvĞēă29ĨĒɬĆĒȢ6,24,42,.86Ąćʹąēĸ96)ĶēĹČġѿđħȍ .rvl .stkėģȠĎĉĮ16ĈĖƢġĔӈĈĆżĄġɇrcąčѯĊħǺĎĂЎ22ĄĂřĎĀĶċāĳtčėЖĄđŀĆĀǡpilĝĉȏĎĞȄ1ĈēɅ-left:-60ŌĀǯćĎӧ4;ĉĝʳ9pxċĀǢpilČĒǙ.3sĎĀǦfcĐăӽĄĀǍ7ĉĕӢ16ąćĹĐĕʝ6ėĠƱĉĀʁĥĈʙ4,34,58,.97ĆĈʗ,20,38,.98)đĂƵčĀІ6ěđѓflip .6ďđђ5,1.15Ąđє.52sčĖįstyle:preserve-3dċĀɍĈćǓ6ĉğӓ6ĒĊƱċĄȳċăҧ8ĢĀɓČĀŽ.rġăɡ7čăčđĐŦĎĀřtğăǤĈąѯđĜŬ1emĎęӱkĚē˯X(.1)}40ĢĎȚĄĀı1ĎĎʌpilĚĀťY(.1ċēƉ.4ďē˲ČĎ˟ipĕĀœperspective(680ćďŚY(96degąĎѕ.85)}7ĔēǿĘĀń-9ĈĀń1.03)ėĤĶĘĀņ0ĉĀŅĉĎт秘境 / 连珠ĆĂǅdgČĆӝĚħǚĕĜѽ6ĄğļĎħȫdgr{gap:4ėĀĠoĞćŝąħʠČăɼćĀŁ .oiĉĀӀ9ĉğǋĄĀĦwxgĨČɊ6,1fr);ąĀƺĈĀӻććҗwxt{Ċćб1ĻĐǸĊēʫēĆѴĒĂҳğāȎċĂ˺user-selectċĀȠt.selĐģпąĪЃčģл2ĉĀȊ.clĊĞђxclr .28ĊđȝąĀībadĊĀībad .28sĈĀĢe0ĒĎƆ214,170,.1ćĎǴe9dfb6ĉĀĻĐĎʣ2ĄčƸ25ĊĀĻa9d2efĉĀĻďĎʥ130,200,14ċĀŷa9e0b3ĉĀĻďĎʧ224,13ĄąʸĈĀĻf0aa99ĉĀĻ4ďĀĻ05,175,1ČĀƳe3c79cċāʴxclrĒēɱĕğœ22);ēđғĘěѝĊĀűbadğĐӁ5ĚĐѩ7ĕĀĞĄĔӧďčʒ42ĥčʒ 1fr}ĆĦƑ{Ĉĕʨ}ęĒЪ6Ĉćʅ64px}ďĠЪ0ĊĀĕĉĠ˻ĈĈёĈĀĥćğȔĆāʞĕĀƘČĉĢĈĀŏ60pxĈĀȑĠĄɚ*,ĆĀǧ*ČĄɜćčҮĉēǨČĪė}
...
ąĀǯ=ģāѴĀČѺĚćŜ(d.role||'散修')+(d.sectName?' · '+ćĀĐ:ąĊӽ今日悬赏 '+bq.done+'/'+bq.totalģąĲĆĆōĉĄӬćĆĮm.ĈĆİćĀĵ功法đąŦ《'+d.gfĄąǝ》'+['黄','玄','地','天'][d.gf.grade]+'阶Ďąż修炼ĐĀŗĒĉķĀċǷ/时（×'+ĄĀęĊĝˠ）离线Āăҟ'+d.capHours+' 小时ĎĀŮ寿元ėĉż / ćĉž 岁'+(m.life-m.age<30?'  ⚠ 大限将至':'')}),dbfąĂʑ?ĊĀŧ状态ĆĆӷČĀģĄĀŸ},[dbfčĘŒĆāǤx.n+' 余 '+dur(m.dbf[x.k]-m.nowăāчx.e+'）'})ĄĔƂ　'ĜĄɺ到点自动消，养神丹可立刻尽去ăćшąĊɁbuffs&&ĄĀĈĒĀǓ丹效ĆĀǓĘĀįċĀɘbufčĀǤćĞĠb.n+' ×'+b.mĈĀˍĆĀǐ、'ąĖЌ]ĮĆѸbreath,btBtn,bqBtnĝąҐ吐纳：每 10 分钟一次，āĄɱ0 次。突破失败会āĂŉ；大境界需渡劫。'+(d.btStreak?'  已连败 '+ćĀē+'ĀĄˏ下次成功率 +ĊĀĬ*10)+'%（保底）。ĄĀп]);ćăǇćāыif(d.farm){var ftc=ąĄĉ'farm');if(ftcĈăȅftc)}ĈĀĎarmĄăɇfarmĄăőv48 活动横幅 + 师徒
var ev=d.event;if(ev&&(ev.ĊĘ˩ev.next)ģăɲįċĬćĀѠ今日活动ĉąȅċĀƉ?ąĀĎĊĀэeěĎǏĈċȸeĄāʥ · '+e.desc})}):[ĝčĲ无事'})])),ĄĀȉ?ĜĀİ晚 '+ĄĀĪ+'：Āąѐ，ĄąǸ（不是副本）'ėĀӓĊĀŇ周一/周四双修日āĂѭ1.5 · 周三坊市集八折āĀĉ六日秘境 +1 次 · 每晚八至十Āąɟ（游历页）Ąčǖ
var hn=d.honors;if(hn&&hnĵĄŀ仙门喜报ĉĀʜhnĕāʻĔėȉĆċˋx.lvďĎĆ.n+' 晋升 VIP'+x.lvĝčˌččʕĄăɑĈĜИx.t)/864e5))+' 天前'})])}))ąĀȠmt=d.mentor;if(mĄĆжmrow=[];if(mt.master)mrowĆĀȯĊĂȄ师承 '+ĆĀĨ.n+ćĀĵ.paid>ćĀĎr0?'':'āĀʴ跨一个Āāɒ师徒āĆȃ与悟性')ĄĊѠmt.ĈĠǱĒĀŶđĀЭ门下：'+ąĀĻĔăȹk.nĉāћĂĂńċĀŮ+'/ĄĀǊxăĂŚ);
if(mt.canApplyċĀƐęąǷĒăɛnmĄăɜask('拜谁为师？输入Āĉѯ须已筑基且境界高于你，一世只拜一ĀĈʧ,'ĄďĜnmĉėʜĊĈЎmentor.applyĆćʺm}ĊĈОċĄѠ拜师'ĄĀǔd.canRenameŊĀǔ新ąĊľ，消耗一枚改名玉牒ģĀǋrenameģĀǅ改āĉʠĄĀʛrowĵāǓ师承ĕĉǒ},mrow),!ĆĀһ&&ĈĀЅ?Ěāʹ拜入师门后，ĈĀӡ '+mt.reward+' ĂĀӰ 1ĆĊĚ]))}
// pathĆĀʙPath||d.canSubĄĀĉRespec){var list=ąĀğ?d.subs:d.paths;var isSubĆĀġ&&!ĆĀŗ;ĬĀȨisSub?'兼修':ćĀƜ?'择道':'转修')ĚăӤĄĀļĀćƪāćʀ，一次定终身ċĀŇ筑基已成，择一条道走下去ĂĀő需 '+d.respecCostĂĀȳ，修为减半ĒĀūgrid'},ďĂȜpĖāғitem path'+(m.path===p.id?' on':'')ėĀӳif(!(await sure('选择「'+pĄĂɟ」？')ĊğӰĉĄяĄĀȌsub':'path',{id:p.idċĈѡĊĀӯĎĂјąěłp.icon+' ąĀžĜĈŽpĄĂ˶])}))ąĀѶstats
ĭāĻ根骨ēĉʢĈčȱćĂә气血ėĄǥhpĎĄɬ灵力ėĀĮmďĀĮ攻击ėĀĮatkĎĀį防御ėĀįdefĎĀį速度ėĉОst.spdĎĀĲ暴đĀƒĈĂʦst.critąąӰĎĄʧ术ĒĄѮăĄ˼spellčĀİ属性ċĀİ},[ĄĠӠst.elem||'无ąĉʤćĀĶ突破加成ĔĊĿċĀƭbėĀƫ劫雷减免ĞĀǭtribĖĀŁ丹毒ĐĀĿ(m.toxĄĊƵ/ 100'+(ćĀĔ>70?'　ąĆƴĈĀĭ>4ćĀĘ85':'　尚无妨碍')}),m.pet?ċĀѪ兽ĈĄ˔ĄĀĝĎĀɂm.pet.elemĄĀŃąăъ'+m.pet.lv+' 级'ĈĚЋćĀšĒĊɜmĄĊȰ+' 点 · 第ĄąŹves+' 世'ğĊȾ丹毒：服丹积毒，过 40 ąĀǬĀĀč70 ×0.6，满 100 便再不能服丹ĀĈҀ自退 10ĀĉǄ清毒丹清 40 点；丹修积毒减ĀĈӌ}Ććɯworld
var w=SćĘбwĮĂɖ天象ĜčœĂČȶw.season.n+1)+' 赛季 ·ĂąǱĆĀĘdaysLeft+' 天ĬĈʨĄăѳĆĢѠ'mon_'+w.boss.id,ąĀĉcon,'mon sm'ďāĆ今日 '+w.weather+'，ĆĀłĄĀЀ现ćĀʫĨĊűarenaĄĊů讨伐ĄĝʜĄăƔdefLog&&ąĀĉĵĂӛ被挑战đĀȳlist'},ĆĀŝĝĄǃĈĄƜ向你论道 — '+(x.w?'你守住了':'你败了Ąăъ(x.dr>=0?'+':'')+x.drăăц}))])ćċҬĄĤĳ// BreakąĥǼceremony: success blooms gold ink and floats tĄĥʆ gains; failureąēœa cracked seal.
var STK=[['hp',āĂƑ],['mp',āĂŮ],['atk',āĂŌ],['def',āĂĩ],['spd',āĂĆ],['power','战力ċē˓ąĈĭ{ĄĒŊĎĢȗ)ĆČǴo={}ČēƞSTKĉēƞo[STK[i][0]]ąĤǹstĈĀĔ)||0ąĉȃoĈĉвgainLines(b0ĄėɊutĄĄˌ!bĆĕӧout;ěĀƧĚĀƞ{var d=(ĕĀƙ)-(b0ĈĀē||0);if(d>0)out.push(ĄĀĞ1]+'ąĐĬd))ĆėćutĉďȕĎĈɥ{đğǋěğƚćĉɸ];
if(r.ĄĀѧąğȾĊĀȼċăФćğŮĀĂȳ成功ĆĆɺcolor:#ffe6a8'}))ĘăћĆČіr.msg||'ĆĄѠĠāǥćğƋĊāƲtĦğƅt})}))ąĢƍĘāɎrąċӝĀĈт'+String.fromCharCode(10)+'ĀĈѝĎĀǮĊĀȥ失败ďĀȥ9e8aıĀȥ}ĘăʟĊĂȗāĆѷċĉŢr.pĉĉś'}));ċĀōĒĉȜĐćŚ4pxĬğɽČĉӝ继续')ĉĠġ;ĉĀ҄&&!rm())ovĚĐʝąĠă);
ĜĀĩġĠŢĆĆǎĄĥӤďĚʶribulation ĄāŧĄĕɤCT=[['tank','硬抗','以肉身承接，伤害 ×0.8（体修更强）'],['parry','招架','耗 10% 灵力ĄĀħ5（法ĆĀħdodge','御剑ăĀħ5ĂĀħ按速度概率完全闪避（剑ĆĀĩartifact','祭āĜȎ'ĀćʲăĀŏ3（需装备武器ăĀĦtalisman','避雷符','Āąʑ张，化去此雷'],['pill','定心丹ăĀĚ枚，回复四成āĂę];
// 克制 hints are derived fromĆĕǋon table above — no extra server data.ĆĀȰN={},TACTDĉĂĀti=0;ti<TACTąāѤti++){TACTN[TACT[tĄĂċĆĀČ1];TACTDĔĀĞ2]ĄČ˕COUNTER={'雷':ćĀɣĆĀȚ]ĂĥĺćĀʤĆĀɚ],'风ĉĀıparry'],āĊĔ:ĆĀȼtank']ĉČŮcounterTip(kĄğɬds=ąĀƇ[k]||ĆĀжĄĀœ;var nĐĤ˙ČĦӺnĄāƳTACTN[ids[i]]||ċħĉ k+'劫：'+nsĄĆ˪ / ')+' 最稳ăĂҽTACTD[ids[0]ĄĠĸćĀƽĆĊѼtıĂš
ĐĥǠwidth:560,height:220ąĠɛhTitle=ċāй'ĆĀĝpI=đĒʾ100%'}),měĀğĄćǣeterćĉүđāȊćĒһpIĚĒғmpI])ĆĠȤtaďĞȨmutedąĥˉtipďĞɉipąĀĞmsgB=ĐāӽąĀƹinfoċĀƸTitle,meter,stat,tip,msgBąĀƓbtnďēˊĚĉĩĄĐҨogĎĀĶlogĆĀƊpanĐČјpanel'},[cv,info,btns,Įġ҃'按钮上的百分比＝这一道雷预计削掉你多少气血（已计入你的气血、法宝、道途与减免），闪避标的是ĀĂǠ。气血越厚扣得越少。最后一道是心魔，靠悟性硬扛ăĐӎogąĀȌtribFrame=0,tribTimer=null,lastStrikećĀďAtĄĀħCalm=false,amp=0,flash=0ĉęɁraw(strike,calm){ifĄĀď){ĈĀŜstrike;ĄĀŞćĈƚ}if(calm)ĆĀůąĝʇ!strike&&ĈĈǇlastAt<520)strike=ćĀŢ;calm=calm||ąĀŌĭĦǦĈĆʫf=ĆĀȵ++ĄĀӧkyĆĤɢLĊěʂĄĕĖ220);skyčĤəcalm?'#0B0F1A':'#05070d'ĐĀĬ.6ąĀĭ1b2a3c':'#0e1420đĀĭ1ąĀĬ3a3f4a':'#171c28ČĤɽskyčĤɾ56ĄĀƯ
ąĀʁĆĨѭr=0;r<16;r++ĔĦƔ280,96ĉĦƗ*0.3927+f*0.00ąĥŻgěĀȰ-300);rgēĤҊ243,226,179,.16)'ďĀĪ1ĐĀĪĎĤѻrg;ĖĦƨ0ĉĦƍ22,-32ĉĀĒĈĀđfill();ĉĥҒvar sunĕĥŷ280,96,4,ĄĀĈ120);sunĔĀǭ55,248,220,.95)'ĐĀī.25ąĀĭĊĕӨēĀĭ1ĐĀīĎĀȜsunĕĀКĉĨʟuffĄĥɇr,body,rimčĦʁvar o=[[-1.25,0.05,0.55],[-0.55,-0.4,0.78],[0.2,-0.55,0.85],[0.95,-0.25,0.7],[1.5,0.12,0.5],[0.1,0.15,0.9]ćĂНq=0;q<oąĂЛq++){ĆĀ˞cx+o[q][0]*r+o[q][2]*r,cy+o[q][1]*rąĦɿĉĀĪĊĀĠ,ćĀķ0,6.3)}if(ĄĀǼĉĦ˱rimĊĦС2.4Čĥӻrimċĥҷ7ĈĦКČĥӑ}ĉĀʢbodyĈħĎvar rimC=calm?ĐāĪ55)':ďĀ˺'+(0.14+amp*0.3ċĩЗ)';
ċăű7ćąǟcx=((i*112+f*(0.14+(i%3)*0.08))%720)-80,cy=30ĄĀĚ10ćĜљ(f+i*25)/50)*3;ĈĀь22ĄĀĮĆā˶36404f':'#161a2a',null)}
ċĥơ5ćĥƙkx=((j*150+f*(0.26+(j%2)*0.1))%760)-100,ky=74ĄĀĚ1ĈĝĘ(f+j*30)/46ĆĀƝkx,ky,30ĄĀĮ8ąĀƝ262cĄāҔc0e1a',rimC)}
if(!calm&&ĊĨĆ<0.0ąĀɱ06ąħѰĉĦн200,190,255,.07)'đāƍ120)}
ĊĀļ#101720'ėā˚2Ċāˉ0,176ĈĀď60,15ĉĀĠ120,17ĊĀđ80,14ĉħӅ236,16ĊĀđ80,12ĉħӓ324ČĀģ38čĀū440,17ĉĀĵ500,15ĊĀđ6čĀƲĆĂƲēĨĨ;ČĀȠ070a11ĩĀȠ9ĉĀŭ80,184ĉĀȎ60,19ĊĀǼ40,186čĀȎ6ĉĀŖ32čĀģ40čĀŪ4ĎĀū56čĀģĞĀǼĆĂˆvar hgęĂƔ140,2,ąĀĉ44);hġĂʂ55)'ďĀĪĢĂʂhďĂʂarcĆĀƌ44ĎĨǺĊĀˌąāŽa2416':ĆăŊČĨɵĄĀĦĄĤҷ:'ĄĜЃ'ĊāҘ0.8ČāҘĊĀńċā҈calm?12:4ėĀƾ36,5čĀƽċāӘĒĀѾ280,141);g.bezierąĨѻ286,141,290,146,291,151ĉĀѤ94,158đĀĺ8,161,272,161,266ąĀĨąĀĺ69ąĀŌČĀĺ7ĄĀŭ74,141,ĈĀƞĒĀѮĖĂƹ;
ĈĄĀvar colĄăӽ===āąȲ?'#b388ff':ćĀė火'?'#ff8a50ĉĀĖ风'?'#8fd3ċĀĭ雷'?'#fff3a0':'#e6e3daĎĀЍolČĀ˨coĄĤɌjit=26+amp*34,seg=11+amp*5ąĤɬltćģіbx,by,ty,w,depth){ĉĀяwČĨ˅6+amp*14ĕĀ˸bx,by);var px=bx,py=by;while(py<ty){px+=(ĊĂň-0.5)*jit+(depth===0?(280-px)*0.22:0);py+=segČĪƳ12ćĀЀpx,py);if(depth<2ďĂưĄĀǁ0.16)bolt(px,py,py+30ČĀř40,w*0.5,depth+1)}Ĉĩˬ;
bolt(280,0,134,2.2+amp*2,0);if(amp>0.55)ĉĀħ20,1.1+amp,1ĎĀћif(ďĄЍ180ĒĂɘ55,ąĀă'+(0.05ąĂʈ7ĎĂӻĕăЁ}
if(flash>ĠĀŤĈĩʣflashĥĀŦ;flash-=0.055ĉĒǶquake(){if(ĉīȼpanąĭӑĊĆŽquakeąěƷpanelĊěƹčĀĶaddĆĀĳĊĪŞopTribĄĤƞąąȯ){clearIntervalĈĀĘ;ċąɓ}}
ćĀĐsetĆĀıČċиĄĘǙĆħĤcv)||ĝħѺ{ćĀƝąĒŪdraw()},60ĉīśrender(t,done,msg,win){
if(t){hTitleĊĮǲtĄĥŸNameāđɅĄĊʌ(t.i+1)ĄďДt.n+' 道';meteręĆЀhpIĄě҂wćĪбround(t.hpĆĈƄ;męĀĨmĈĀĨ
var b=t.bolts[ĄĀćĄĄǹ-1];staĊĨЊ='来袭：'+b.k+'劫，威能ċĈȎb.ĆĀś  · 法宝 '+t.art+' 次';
tipĊĀŌĈćǍb.k);tipĚćĀampĖĪʿ.i/ĈīŁt.n-1))*0.7+(bĄĈʤ0.8ĆĈҢĐĀʭ'劫云散去ďĀʆċĈɳďĀȐ';čĀǖĄĀĒĕĨĴ
msgBĊĀİĄĈҊąĈʼbtnsĄĊʱone){draw(nullĄēǙ
if(winĆģɇ{ĄāǓĄĜӭfoĎĝČcrk'))info.insertBeforeęĉƞ渡劫ĘĉƞĀĉŽ}),msgBąĀɏflash=1;if(!rm()ĄĒǧďĆӗąĈѢ;ČĈѠbęĪǚbĊēˈbĖēˈbl)},1700)}}
btnsĜĝƃĖĒӎĈāȒĦĉƀ天地归于平静'ĆĀѢvar FC=t.forecast||{};TACTďĝɆaĄĈĐk=t.can[a[0]]!ĄĀˠ&&(a[0]!==ćĈɀ||t.can.ąĀĐ)ĈĀĤĆĈɾąĀĤąĀĐĉĀĤpillĆĀĠpillĄćǘlb=a[1];if(ok){if(a[0]===ĄĈʫ&&FC.dodge!=null)lb+=' 闪 '+ąĀĘ+'%'ĆĤ˞ąĀĽĆĀƔĄĀİ免伤ďĀģpilląĀğ回四成ćĀĠFCąĀȑĈĀŲ−'+ąĀė+'%'ĜĀ˰ćėРokĄĜӽa[2]įēɤep',{act:a[0]đĔǛrĆħУraw(Ėāћ.k);ąāƸvar fin=!čĘǱhomeĐē˅;var TLĎĘȠtribLog)||r.log;if(fin&&TL&&TLĆĥĦvar L=TL[ĆĀē-1];logěāȝAĆČɢ'+(LĄĂǃ道'+L.Ąĉĕ(LĆĩӱ)+'，伤 '+L.d}),logĉįҋ}ĝĀŪĆĊƷąāˣ?'B':'A'+(fin?' bigĈěӒr.msgďĀŦĐĦѦĔĀɏĄĂ˙čĀė,ĉħ˙ĄĀģĆā҇,r.msg,ĆĀƪąāƭ)}},lb))});Ģāʂdanger'ĨĎБ临劫而逃，天劫会追着你劈三天。确定ĉĎДčĀҰflee');ıāː逃'))}}ĔĪѳpanel);draw();ĆăĚĄĀȂĎěĠattle replayĉăőplay(bąĪȥif(!bėĪǏĳċҕah=b.me.hp,bh=b.foe.hp;ĄĜҝAĚĉЅbarBĚĉІĜĉǠąĆӻvar tďĉҎb.mĆđй 对  '+b.foeĆĘѿvar meKey='seal_'+(b.me.r!=null?b.me.r:(S.me?S.me.r:ąĞбfoeKeyĄĀǯid?ĄčʥąĀď:(b.foćĀŊąĀŠĄĀĕ:nullĉă˼fighter(name,key,fb,bar,sideĖďЉĄĀĴ '+sideĐĊĞpfċčъĄĀŘ'pfĒĘǳfąďʛĔďʎćĊŭbar])]Ąć˚fA=ąĀƾĆĀɱ,meKey,ćĀďbarA,'L'),fBĈĀĮąĀʎ,foĄĀİfoe.icon||ĈĀĝbarB,'RĄĀѲturnĎĀВvsąāп对ĆĉӻskipĊĔмtitle:'胜负在出手那一刻就已判定，跳过只是略过演示ĒĂҩi=b.lĆčӉ;finish()}},'跳āĀĳċĀ˃nish(ĄĄɶ(log);b.logďĂҐe){logĊāǱline(e)Ćěſast=b.log[ĉĀƁ-1];barAĊĄƀpct(last.ah,ah)+'%';barBēĀĤbh,bĄĀĤturnĊăЪb.win?'胜':'败ĄĀĞćĲ҆'vs '+(ĄĀģwin':'lose');ĄĀĔfB:fA)čā˿down');clear(ctl)ĵăȶĘāњĎīƑ},ĊĀǋĊĬŀĄĀɪ{var who=(e.s==='胜'||ĄĀĊ败')?ĆĀҼ:e.w==='A'ďĀēB'?ćĀҧ:Ąİȫt=(e.t?'['+e.t+']Ąī˳who+(e.sĄĕĢe.s:'')+(e.d?'  -'+fmt(e.d)ąĀėc?' ĀĐƐąĀĎe?'  '+e.e:''ĕĘӢe.w+(e.cĆĀǌĊĀǗĎĂ˞tĊĩѢhitĄĪƕ!e.ĊĮɅatk=ćĀȈfA:fB,tgtĉĀēB:fA;atkĐĂĳatkąą˧atkĊą˥ċĀİaddąĀĭif(e.d){tgēġʦtąĀőtgtĊĀőċĀİĄĀЩtĄāȽdnďġʪdmg'ąĀɮcritĈĀȞ'ĈĀʕ});tgċġɹdnĘĄɘdnĉĄɘĊĀčĊĄɘdn)},900)}if(e.t)ĎāƘąĨū.tąĮȷtlĥċЭ8px'},[skipďēʖtipąāзąāЕ已由ĀĝʳĈāИ，不影响结果ăĐŮĪĭУ'},[titleĎĂŉarena'},[fA,turn,fB]),log,ctlĆĔĄtmĘĆƍi>ĊāҚĎĆǬm)ĆāҭĉĂӠeĄāєi++ĐăғĄāșĎă˪hit(e)ēāѹeĞāѶeĈāѳ},420ďăǁĄęһĄĘЁĄĀčĠĘЄregionsĝĘЇĄĘ˰xploreĄĘВ,null,'ex'ĊĴӢsubnav(items,cur,pickĜĔȠitemČēҺĊģƬČāӠcur===t[0]?'pri sm'ĖĐɳpick(tĄĢʡt[1])})ĐĜƾĄĀǙd,result,suĄĳДĄĜǀsub=sub||'ex';čĘӆĆĚц,ĆĕʬćĀĒĄĀȐ[['exăģѾ],['dg',ĀĚƂ']],sub,ĉĐʇif(x==='dg')dgLoad(ĄĄǤĊĀ˝()})];
if(subąĀįĄęƚDungeon(kids,dĊĞʋĄīƜćďąresĄĕѾąĀěąĐҏevenĉĀĩevenąęƢevent)ąĘƫĭĐҡĀĀȄěđȦ体力 ďĠʻĄėȄ '+m.daily.exp+'/'+(d.daily||20)}),(d.ev&&d.ev.hot)ĎēҴćĕРċčƜ4ĉčƜ🌊 妖潮进行中 · Ąĕˆ · 遭妖更多'ďĴŝċďʊĂĚӻ:00–22:00（北京时间）Āěą就在这里ćĕГ、āĀŊ，āĕИ。čěĻĞěɊ每次āěƤ 1 ĊěƧ攒到ĂđӪ就不再涨）。一趟最多走 10 步，回头再来或服辟谷丹便可跑满今日ĒĀŞgriĖěɘ},d.Ąāȩċāƥrěēѥrg'+(r.open?'':' lock')},[imgąāɼ_'+r.id,'rgimgĐėǈąĄŕrćē˱rġē˱rĄē˱ĔĜъ-top:6px'},[ĄĀƣēăɋ sm',ĆĆƠm.st<1ĨĝҷĆĥŹ{region:rĆēӱċĝӆąāʄx.data)}},'前往'):đĖ˝ąĀЇ需'+RN[r.realm]})]ĆēӟčđѱćĴǼĆāǅėĄЙĒāƵe.enc?'遭遇':'奇遇'}),e.encĎāśencpđĒʁe.enc.id,ĄĀĈąĒɿĉĀ˲ĘĔǰe.encěĀ˷ćēƶe.encĄēƶe.enc.desc||''])])ĕĭҸĆĐѿe.textěĀк8px'},e.optČāĕoĄċƒid=o.hidden&&!o.ok;ĖĂǓ'opt'+(ćĀįo.ok?' hiĄĭɴĈćġ.Ććģhid?āĬѦ才看得见的门路ĊĤҤğĀҙchoose',{opt:o.idđĂЃxĈěȋxĉīПĄĬǍx.msgĊīɫ}var res=xĄğȗesult;if(res&&res.battle){ĄĆšćĀĒćĂȈĆěɥĊāĕ,res)})}ĈĆ˳đĀĠ},hid?['？？？'ďăʳreąĮ˯ĂĭƢ})]:[o.label,o.req?ĘĀĲo.reqĆĕҽ})čğčćĂɌ){var partsĄĒʅr.lines&&ĄĀĈąăɻpartĔĂȿreąąʗąĀĳjoin('\n')}ĄĆŋgĆĀŞxp)g.push(ăĢʦ(r.xp>ćēƖfmt(r.xp)ĄćŽlsĆĀįĀĝѦ'+(r.lsĎĀįlsąĀįwuĆĀįĀĖǆ'+(r.wuĈĀįr.wu);ĉĒǕĘĀǚĉāҫgąĐʰ· ĆėȎr.drops&&ĄĀĈġĀȭow drops'},ąĀĵĊāƚdėĘȳdrop'+(d.lost?' lostąĞȆĉıĄd.id,'ico sm'),d.name+(dĆİҧd.n:'')+(d.q?'（'+d.q+'星ĂĭТ)ćĀŠ（遗失ăĀĒ])})ąĀǱĄāĘċĀǢĩĜŞąāőąĀŉĂĞу看战斗'ąĄȔgĄĠʹrops||[])ĎěƞćĔĊ!x.lost&&(x.nċĸǔx.n>0ĄğĚgoąĘҨ)ēĄӊĄıѱgot)},80)ĆĨħģăȭ经过ĉĒƮpartsĐĒƮ秘境čĢˣąăмďĄǶdgĸĄǱdgĊċĽdgPĈĀȲĉĒѾxĆĒѼ}ďĀƚGo(iĐāғdg.pick',{i:ińāҏ
ifĄāНčāѸĊĀĕĉāѻdgAfterĆĂҋćċŻČĀĘĉĀȇAfter(ĄĭȻb=d.bank;ĆĀѴb&&b.drops?ĄĀć:đĀѾzćĀѾz.lost}ĄēШćĀѥĈĀѐėĂİdĉĀʮĆĀƿĘĀģďĀʣUse(ąıжČĀп.use',{id:ēĂȶċĝтďĀʦvďĀʦĈĀĘ)ĪĀѿLoot(l){modal(lĊĚĹlĐĚĸĊěūame+(x.n>1?' ×'+xąāʽxĄāʽxĈāʽĆęŃ\n')+(l.n>ċĀŮ'\n…共 '+l.n+' 样':'')āğŪ里还什么都没捞着。ČĀƺBankCardĈěĚĢāȓbĄĠĢ秘境通关':b.dead?'力竭而返':'收手而归ĜĄџ深入 '+b.depth+' 层'+(ąĀń · 所得折半ąě˧ĚĄʆĀĂɤĄĔҾb.xpăĜƥāĠƯąĀēls)}),
bĊĂǀ?ęĂƵbđĂƵxĞĂƵxĝĂƵxċĂƵČĀ˸ĝĀ˷ćĀŠ（行囊已满ĈĂƷ:null,
bąĂәbĊĂә?ėĂӎbĐĂӎąăŔĉĀСOpt(oċĔөĐăк dgoĒĂȏĄāѨ}},[o.id?imgąĄƏoąĀȒ'ćĄĎċĀɜoiĆăǴi||'·ĦĠӦo.nęĄƤo.elem?ĄĄƫo.elemĄĀƃo.dćĄƥĎĆƧČąӗĄĕʻd&&d.dg;var ĉěаdg');if(ĊěЭtcĆĸˢĉĄРĉĂīd.bankĈĀĳĈāƧĄĀěĄĂьrun=g.run;
if(!run){ĭĆċĀĆȄĝĤʆ余 '+g.left+'/'+g.limiăČҶĘĴӺĄąЩ层给你两三条路，自己挑。所得先寄在Āāʍ，收手或通关才入行囊；死在里面折损āĠ˛ĞĀŊ入口要气血过半，手上没有未了的事āēƃ层是秘境之主ēĀļĚćяg.difėĝąďĀӦx.ok&&g.left>0ČĆӹćĄНx.ok||g.leftĞģɠčĂǔenter',{diff:x.ņĂǚĝĂǍ}ąāʐăĈӘx.n+' 层ĂĆɷ×'+x.lm)})),
g.best?ĦġЕ6ćġЕ本周最深 '+g.best.dĂāӴćĚʄ;ĮęЄāĀŏĘėѥg.boarąĪɷ?ąĀĎĨĜķ+ąĻ҄x.uid)==ąĈ˄S.me.uid)?' meĖĢʩrankċĨƻx.ranąęГĖĠӝxąāʻČħӊćħѧ第 '+xĆĀɂ])ĝćč本周还没有人下去过。'đĆƛĆāɺįĝťdghčāѺrun.diff+' ĂĎˎrun.f+'/'+runăĀїğĪĬ❤ '+dgP(runĄħҳ  ✦ĈĀēĆħѿĜĀŇ💎Ąħ˅runąĨƔĆħпrun.xp)})]),
run.relĚĂТgr'},ąĀĨĥĂРtagąĪŏx.n+'：'+x.dĈĀ˪ćĂ˄ĔĜҽĬĄҁĄăʏrun.loot)}},'ĀĢɄĄĀʊlootĄăț),run.sēĩıąĀɁ守护已碎Ĉĝȶ
run.laćăɰĘąЯąĀĩĐĂѡĆĶȣdy=[];var p=run.pend;
if(p&&p.t==='ev'){bodyĜėʳpĄĆг);p.oďċƲo,iČĀņđĆЁěĂӂo.l))}ĈĺȠćĀƥshopĚĀƧĊĀҗ行商靠在石壁上，货只卖一件Ăāƕ;p.gĴĀƴ dgoĈĂƁrun.ls<o.lsĜăƐėăů'🛒łăūąăƽd}Ēĩɀćā˓o.lsĂĜŪĄģЖ);ĚĀǵĖĀӺGo(-1)}},'不买了ĆĎѬċĀʪrelicħĀʫ石台上浮着三样，只能取一ąĀʪrĺĀʪĶĀʕ✨ŏĀʔńĀɬ取ćďǘrun.ąĴŅĚĀȢćĄś)})ĤĂŽćĂЀp?'眼前':'ĀĤĸ路ĉĆƞbody)ĦĂѐĤāѯċăǢrun.pillOkēĀȗUse('p_huixuĄĎĬ服回血丹'ĖĚҫıĀŚlingąĀś灵丹'),
ēġɺįĎɀ收手离开？所得ĀĤɵ这次秘境ăĦȒċĝŖčăʶleavģģˋĢăʭąĆǉvćĉƈ收手ĆěƪċĉŖĎĎɉgĄċƃbagĠċſbaĤĆ҉Bagąăз'itemsċċŵćĀĤdćĊһinv=d.inv,sk=d.skillsčħƖtabēėз},[[ĄĀŪ,'物品ąężs',āĵʆ],['skills',ĀġС神通'],['craft','炼制'],['pet',āĜɧ]]ħċǝsuběċǝđĀсtĄĐƣcraft'ĒħнcipeĔċ˨x)ćĀȿObject.assign({},d,ĄĆӫ,ąĀŝĆŀŶąĀŵpeąĀųyĉĀųpeĔĪľyěĀůyąĀůpeĆĀŭĉĀˠčċˎćĂӌĉċȎĄĀХ{var groups={};ćĸˎĎāОit){(groups[it.k]=ĉĀČ||[]).push(itąāҳĉĘʣĄĀǈkeysĄĀŅĖģǇČĉӮh4ąāєKINDN[k]||kėĞˬĄĀƕkČĀѓiĄęƶfx=it.fxĆěѲusable=it.kĆĐӆ||ąĀĎegg'||fx.biguan||fx.ripen||fx.learn||(ąĀĭmisc'&&(fx.arrayĄĀĤgacy||fx.rateąĉƕoTo=fx.seed?['去播种',ēĨɞ]:fx.rune?['去淬炼'ďć˓Bag(d,'arts')}]:null;ęċŹ'+tcl(it.t)+(A[ĊĹӀ]?' icąĄзrimEĄĀĩ,ĎĹӫđċƌ},[ąįёĄĀĵĆĝГĄĹҤĜĝˀitĎċƘěąаĄċƤusĥģˡğĊǺććҽtĔċƍĝāȋąā҄},ąĀЛbook'?'研读':'使用ąĆєgoToġĀƳgoTo[1]},goTo[0ąĊҢċĀŜnull:ĲĠʧĉĠʦ卖出给坊市（折半价，立刻到手）　单价ąēȨfloor(it.v*0.5)ĂăБ　数量ćļʣt.n)ĄĹЄąĹ˲ĄĂƯnĖĠ˝sellĈĀɬ,n:ĆŁǏĻĀɸĀĀǈ'),m.r>=1ĨħӸauctionForm(ćĀƕmax:it.n,nameąĺҠ})}},'上拍ĆĨėąĊ˱ĞħҡĄĄɧ囊 '+čĺɁ+'/'+inv.cap.stack+' 种　·　卖出＝ĀĀʔ卖ĀĀʜĂĀʘ；上拍＝挂拍卖行 24Āģӏ，价高者得（手续费 5%ĄĢǪĈĿĨub===Ąāȟ{čāҙěĀƣ已装备：'+['w','a','r']ĎĨжĄĻʩĆĺʭčĉƳaĆāӚa.iid===inv.eq[s]})[0ĆŁǆSLOTN[s]+' '+(it?ĄĀɧ:'—ĈĈќĄĊЄĬČҢĆĀƜĊĀƼaěČҡ'+tcl(a.t)+(a.equippeĈĠЉĉāмaĔāлačāкaėāйĘıɹa.ąıɻSLOTN[a.slot]}),aĆğɳĒĮȃrĆĐҹ★āĀĀ'ĆĦӗa.qęĩҍćČȭaĄČȩĉĂ˂a.st||{ėĥҌ(STĄĂʪ)+' +'+(a.st[k]<1Ċłǥ.st[k]ĆĔӕ:ĄĀĐĈĀˮ')+(a.q>1?'　★'+a.q+' 品质 ċĠƉ((a.qm||1)-1ćĝǒ:'')]),a.af&&a.afĕĆĘĉĀӳa.afċĀǖfĆĀǖf.nĄĀǎf.vċĀǊf.vćĀŷf.vđĤʮ,a.rn&&a.rnġĀƉ'符纹：'+a.rnĕĀƏSTN[f.st]ĺĀƕīĂɩĈāĉıĂŬċĂɩnequip',{slot:a.slotıāӷĄĂӼ},'卸下'):łĂІąĀƚiid:a.iĳĂЉćĀƘ装备'ĞĠďğĄӿ把「'+aąĢő折半ĂĂď得 '+sellV(aăĂʕ？想卖高价请改用「上拍」čąĞĎĂɽArtŇĀǤĂĂɴħĂɭrefineOpen(a.iid,d)}},'Āă˦),!ćĀѨ&&ļĂˇąĀǜ,name:aĘĂʾěĊ˒法宝匣ĄĂʳĈļҗĊĂʲarts+'įĂʯĎĂʮĄąĿĄĠĶel=sk.eqArtąĨҚďĄɤċĄȮĀąŸ（被动ĀģĿ修炼）ĖďǓ},sk.gongfaċāɣgĚĂȚ'+(gĒĂȐg.locked?ĄďǎĞģİąĀİ||ćĀŐĖĀҮgongfa',{id:gĴăҚąĀɗęģľ'《'+gęħƼgĎħƹĚĂɂgĄĂɂĂĨɲ'+g.rate+'ĂĞŶg.desc]),sealBtn(g,dġĀҊ用不上ĀĮŎ神通可「封存」成秘籍，拿去坊市上拍；ĔĐĭĈĀЗ神通（出战 1-3 个，点击切换ĜĀНĒăĶvar on=sel.indexOf(a.id)>ĄĔȰđŁĕtem'+(onĉĀЯaĭĀЯąĀİĉĀУiďĀƇ;if(i>=0){if(sĆĉĺ<ĆĶʎ;sel.splice(i,1)}elseċĀĬ>=3ĆĻƕ最多三个ċĻɝ}sel.push(a.id)}ĎĀҬarts',{ids:selŏĀҪďăơaĈąŪa.mult+' 耗'+a.mpĜąŶaąąŵąĀ҅a,dċĪэ)đāʤĉĆɑrc=d.ĄĆɉ||{pills:[],forge:[]}ćľƗrlist(list,tiĄčɲturn ċāˁąŀƾĦĤ˗rĝāʴr.caĊĐѭĉăӂr.outċăӃĉăҸr.outęĐҀname+(rćčĭrĄČȵ' ċĘɫrćĘɫĝđǋr.iČăǼćČǬićģɭi.have+'/'+ičĦǌ · '+rĈĈӂĦđėĕăłĈĈđ.canĕċŚĨĐūraft',{idĈĐӿćĎǌvar nd=ėāĪ;if(xĆġҴĄčӿ[{id:r.out,nameĄĀʠ,n:r.n,t:ĄĿ˺nd,r.out)}]ēĆəndććǚĊĖюčĀĜ},'开炉ĄČӸ]}čĂʛrlist(rc.pills,'炼丹（丹修 +25% Āğƹ，丹Āģѳ）'ĆąȸĆĀĭforge,'炼器 / 制符（器ćĀĲ与品质）')ĐąǧpetąąǦpetBody(d)}ČİɜbagĦİəĀĶЂīģѤĈČʞ随身之物'ĜċȱčĳƙĄĉѧ,tabs,bodyČČӭenergyForm(eąČӧİĠʎn=čĿҹąĆƴĄįɋ'1',min:1,max:ĉŇǥmax(1ćę˃e.left,e.balance))ĆŁĤĉĠɢąċĞerrąĖџouďĠȪnumēĠĕ}ĉĖďcalc(ęńȘąĆɆĄĿƶ||0,ďĀƧ;ouČęВ换ĀħѶ ąĀʑk*e.rate)}
n.oninput=calc;calcąĺƎobĕīщ},'供奉');
obĆĿˠđĂ˔ob.ąāɓąāǳerčęҗvar k=ďĀǖ;
if(!(k>=1)){čĀķ至少供奉 1 点能量'ĉč˅k>ćĀȅĎĀĳ你只有 '+ĆĀĠ+'ĎĀľċĄʓ确定ĀĀţ'+k+' 点论坛能量，换 '+ćĀȼăĄʒ扣的是论坛上真实的āĀğ完不可退ĉĄʘ
ĈĀȁ=true;obċĀƓ供奉中…';
ąĭҤċĄҨnergy.offer',{n:k},{forceąĈі
ĈĂѻĝĢҖĄķӦćČɹČĀȞx&&x.msg?x.msg:ĀĀƙ未成，能量与灵石都没有变动'ĆĽɈĉĀǓfalsđĀǔ'}}ōŃęĈġб能量āĀšĝčҹ把āĀʳ供入ĀĽЯ，换成灵石。ĂĀЭ ＝ĄāăĉĀ˄（随境界水涨船高）ĀĪȇ最多 '+e.dailĂĥҭĚĎĢĘġǤ你现有āĀſčĀѰ，今日还可ĂĀіeĄĎǛĎĀŢċĀŔ8ąİǺĀĀɕ ',n,' 点']),out,erĖČʿobĝİűěŃŃ算ĂĮŷ,vĄĎіeĄĵƏĊĜŁĄăɒx,d){if(xĆĄ˨||x.basicĊĮʮėďǋsm sealĖĂњev){ev.stopPropagationĄěŝċąц《'+xąĄˡ封存成册？自己就不会了，秘籍可上拍。Ęħҩ'book.seaĄĈƶxĎħҢĚăӜrĐăӜ'封存ąńұVIPC=['','#c9ced6','#e2b84a','#7fd3ff','#ff9a3c','#ff6b6b','#c58cff','#5ff2d2','#f0e6ąĀıd700ĊĿӋĆĪźlv){lv=lv|0;if(!lvĔĀʑďćʟvipbĆĀӠborder-color:'+VIPC[lv]+';čĀĒĄĀӽVIP'+lvĊėȥąĀыv){ĉĊӫćįǋpctĄĿʉ?ĊķѷĈăѢv.en/v.need*100)):10ĄĵĪ=v.nowĆĊĀhead=h('tr',{},(v.colĄĒǼĊăѸcĉĄŜthąāɤc}ĆēŪrows=(v.tableĐĀŁr,ĄđӔl=i+1ĈĀɕtrĆĀɓl===v.lv?'cur':l<v.lv?''ćąɔrčńɮjĊĀƘdĆāșj===0?'ċĀɹ]:''ĉńɽĐİӋēńɹ;ĄĀ˛top:1px solid var(--line);paddingĉėȖĘČǄĈęŜbigČĥȑ'+(VIPC[v.lv]||'inheritąėжvĈĔ˩ĘĎɠ累计Ăāрv.enĂĲǠ+(Ąīʨ'，再 ĄĀčed-v.enĂĲȁ升 '+v.next:'，已至顶')ĵĶɃĆĶɂv.lvĎćӣvbigĆđȤĂĆđwąĆđ· 离线 +'+w.off+'hĄĖŝ'+w.drop+ĂīĢ日游历 '+w.exp+'Ăī˪ĂĀǧwĄĀǧ/日ĘĖƂďĀ˜4ćďІĀĀņ5āĂǼ即 VIP1；每升一级ĀĮ˔、掉落、āĭɆĀĴң与供奉额度全线拉开，并解锁新权益ĒĲʌoverflow-x:auto;ďĈłh('tableĈĀȒt'},[headċı˫đĀɿlistėĈƟ(v.extrađāǂeċđȪĉĀŕ(i+1<=ČāŬ)ąĀťfont-size:11ĆĀȮe}ğĆʥ等级只看āĀ҆āăǵ只升不降，跨转世永久；改版前的供奉已按每次 3 点估算补记ăĘȁĉłӝĈćˀiĲĤѴĢĄǤit.max?ĊĄǝin(it.max,1))ČĄȆit.max||1ąĤʬiĘĀŢĊĳҴ起拍价（灵石）ĄĀŌĥĄȠęĄśāćһŇĄśmvąĄŜmiąĄŞĄĄśmvēĄŜ请先填āĀǕ至少 1 āĀǚĆăвĞăӎ上拍Ċăӎitem=it.iid?{iĄĊѶid}:đċĘĆŃ҈ďĆѲuction.ĆĵǨitem:item,min:mvũĄė没能上拍Āłʔ后ĀŁɸĨĄĒĀĀ˓ŚĄĒ上拍 '+Ćċǀ,ĄĀӾĔăѓ6Ćăѓ数量 ',n]ěĵҲĆă҂miĞĮɕĂĈІ后落槌ĂĈЉ。ăĈЉ（商人免）。同时ĀĄŚ5 件在拍（与ąāȅ.js 的 MAX_ACTIVE 一致）；卖出的钱一领，位子当场空出来ĂāҊer,ŔăӧāŅťĄŇīČĎǕ淬炼 / 灵田 / 灵兽
var RN=['炼气',ĀīӀ',ĀīӠ','元婴','化神','炼虚','合体','大乘',āĞҫ];var RN10=RNĆċк'仙']ĉą˰ąĉˠĊĕŋfloor((a.vĄğȥ5*(1+((a.qąĊЋ0.15ąĳˊSTN={atkĂīȚ,defĂīǳ,hpĂīʉ,mpĂīɢ,spdĂīǜ,criăīƳ,ratĂıı',spellăīƈĉĥ˸ur(ms){msĉąҌąāɏs)||0ąĵ˳Ĉăʥms/60000);if(m<6ĆĩƆĈĆťm)+' 分';var hĄĠďfloor(m/60),mm=m%6ĆĩǳhhăįӠ+(mm?' '+mmĂĀĿ:'ĐĔӄĈĉѾiidąĆɋČĎȚfine.viewĄĊĥiĔėȊ||!xĄĵӃ!ĆėǜfinćŃҫ炉子打不开ČĈɅS.rflk=ĄĄŦfineDrawąėƯĄĊĒ
ČĀƱDraw(dd,ĈĀƴčĂȚvar r=ddĄĀƃĄĞ˝ęāˣĄĀƐĜĆйĈĩɹutěĜĶĚĄЇ{inv:dd.inv}ćĊɁćĀŞbackąęӯ&&xĄĞȊċĀɗĕĀȯ;elseĄĀƠĉĂёfRowąĖŗa=r.af[i];ĄĉǊĄĀʈ==iĖĖʀģĳЀa?(aĆċЦačċʐaĉċʐa.v)):'空槽'}),
aĐĊ˞on?ąĈŶ:'smąĒƬ'保值重铸：属性不变，数值Ăăŗ费用翻倍Ĕı˅rflk=on?null:i;đĀт}},ĀĀŒ'ĈĒǫĚĐȉon?!r.reforge.canLock:ċĀĒĪķƼfineąĀļćāŦ,slot:i,lock:on?1:0});ĄĀЙ}},a?(on?ĂĀȋ':'ĀĀĄ):'开一槽'ĆĝмrowĐĨȼr.maxAf;i++)rowĄĐ҇ąĀНąĠŋk=(S.rflkĆňѯĆĀĎćńѲĄĨǘosĕħӱąĹɖ铸 '+(lk?ćĀȢlockLs:ĈĀĐĄćӼ ·ĒĀīMatĉĀĭmatčďɂĎĖƹ' 需ąĔį（有 '+xĄĉĥĈıț、')+(lk?' · 保值ĂĀё、ăĀёĄĕӢąĽƍl=h('select');(r.star.candąėШĎľŞ){seĎļłoption',{valuećēѼiid)},ččƤx.q)+' #'+x.iidćĈŗstarĘċǺ升星ğĉǧq>=5?'已至五星，无可再升。':'以另一件同名法宝为祭，ĎĪȯĄĀǱĆĉʹ，耗 '+ĄĀĔĄĉɛ。失败只毁祭品。ĀĄз星，基础属性 +8%（词缀与符纹不受影响ĀıǞ}),
ĉĀȺĘēˑ'},[sel,ġĚɶ!ćĀœĨČɊ以 #'+sel.value+' ĀĀǶ合炉升星？ęČȱĄāƫstarĈāƨwithIidąăҢĆĀŔ)ĊāƯ'合Ăĉȟ:ĜĎЕ里没有第二ĂĀʇąĝĖvar sockĊāǌk=0;k<r.maxRn;k++)sockąěҷuneSock(k)ĊģĆćĀĖ{var rn=r.rnĄőȣ!rąďƧ ęēѵ◇ ĂāҰĉĂĦĻČӓ剥下'+(STN[rn.st]||rn.st)+Āč˿？纹路会碎。ĠĀʐunrunĉāлk:kĊĀɼĒĀŠ +'+(rnčĂƤrnĉĂƥrn.v)+' ×ąćƤbagr=(r.runeđąɦęĕҨČĒɒ!x.had||rćĎĒ>=ĄĀ˓ěĂŁyđĂŁċĀȂruneąćʟback(yĊĕьăėǗĆāɒrunesĘāɓ符纹ĂŇǘĆĀƧ+'/'+ĄĀƪăāѓĔĄŻsocks),bagrěāǯbagrĜāĝ没有符纹。炼器可制，秘境与灵兽也会带回İĞĻīĄвĀĄǠăċłĆċŮčāҦr.q)ĎČɦ词缀ĂĀȯĆĎѴćĀȯAfăĀȯĔķӖcost,star,runesĹĺŚąĀсshut},'收Ăāɿ])ĊĈʞĆĳĒf){if(!fċņҡĉķȮdPick(iĄĀħ.seećıҐąăӤ手Āāʾ种子，坊市有卖，游历战胜也会掉'ďěȁīĆǉŖĀ˚ĂĤ˒ĄĤː块田播什么ĘčĊąĀǯĤĹĵĈĐŁsČđѨsċĐīėāǧĘĄŜĎāЇfarm.plant',{i:i,seed:sĎčХċİрĉČǠsĔĐƙ,ĈĹƜăāȶsĞĔˀs.ăĄ҇后收 '+s.mat}Ĕč˔ěğɗŀĉʛċĉʌtile(p){if(!p.seĆĆЕēĀˀfe onĕķҳdPick(p.iěĎŌ空田 '+(p.i+1Ėęȳ fąŒź'点此播种 ▾ĈĂ˹kids=ĊĀʩĄĀƸĖĀʫĖıǳĝĈƺ(p.withered?100:p.pctĆľэ];
ifĈĀĢ)Ĥĭѻ已枯萎'ğĸȏğĄȧfarm.clear',{i:p.iąēҡČķЬ理')ĈķǴp.readyĥĀƭ可收 '+p.matName+(p.hurt?'（受损 '+p.hurtĄŉ˓)ěčħĬĀǙharvestĆĀǛŃěǟĈĀĘ);ĄčĚąěǚĘěӧĐěŨĔēʠăĕĂ获ĆĀɲ{ĤĀɧ还ĂĲˍur(p.left)ćĀɩ · ĈĀɫ:ąŀɌif(p.evĥĀˇ⚠ '+p.ev.n+'　ąĶıp.ev.leftĖĀʺĮĀʶtenděĀҏ处理（ĄĀƊcosĂĀл))}
ğĂķp.t)},ĄĕɋĄąǏěąŧ手中种子：'+ĜĂƪĎāӊĉđȒĬĜɾ灵田药圃ĜęҢ共 '+f.n+' 块 · 筑基、金丹与九宫聚灵阵各开一块'}),ċĂщ?row:ěĀǥĂĂѢ。ĉĂѢİğʵf.ploĄď˚tileĝĉǊ成熟前每小时可能出事，两小时内不理会便受损；受损两次就枯了ĎĉƾćčѺ{var pv=d.petćłр=pv.pet;
if(!p)ēĔӼėĀƍ尚无灵兽。ĀĄЫ的兽卵可以孵化——Āďӷ掉，灵兽远行也会叼回ăĈč(pv.eggs&&ĄĀĈąăƫ?ĪĂʄąĀļėĶşĕąƠİĔɲeĎĂҰŖĕк}},'孵化 '+ąĤˇ（'+e.peăāơąĘӹ]);ďćжlćĝȺőĀƙĄĮ˥pĉĈī(p.hpPĆĝȴĄĮЉĄċʼĢğѢ(p.mon||''),p.name,'mon'+(ĉıǪvip)>=9?' aura':''ĐāĘĈėӕċĂҀ ĄĀĘąĕȄp.eggTier||0ąĀŵ+'　'+pąĳě+['','　化形','　仙形'][p.ev||0]ĠēʛpąđŘ攻击ĄčƮp.atkăď˵ĀĽɁąĀēhpĕċǈęŁҜhppĶŁш(pv.maxąăŇct(p.xp,p.need)ėŁҠĊāǤĂĀǁhpp+'% · 历练 ĉĀŗ'圆满':p.ĄġˤĄĀŘąŁЇĄĮ˧pĄĂȵtrip)trĉįŷĎąǟ远行ķĻ˴p.tripĄġȆNćěƫ(ĆĀĘady?'已归来':'ćĂʋtriĄĂ˼ĔĂʎďĆ˩ĉĀŐĨāɟpet.collecĕŁƴŻăŚreloadăăŊ取ĄĻӉćĨƊĎćɾpvąġѲĔćɼrg){if(rg.open)ğćʈrg.id},rgĈġчg.name))});
ĞĀм（ăĜʉpv.tripąĳҟ次ĘĆė[selĆąЂ(pv.hours||[4,8,12čĆɕhhĦĆɖĉĀƄ<=0||p.hpP<0.3ĬĀвsendćġқĆćǖ,hours:hhčđӕload()}},ąĉ҆)})ĝĂї远行期间不随你出战āĽɢ足三成不能远行。回来带āĽƳ尔有兽卵或奇遇ąĂѝvar feedĘĀʈ喂养ąĂ˹feed&&ĄĀĈĚĂ˹},ąĀĥċĔѦdĝĀɰīĀɌfeedąċʓfdĐēƾĆĀȽfĄĠȷ' +'+fd.xp)})ěĆЙćāЖ它已至二十级，历练圆满，再喂无ĀČңāŎɉ与含修为的丹药都能喂ĉćєlack=(p.evoCostĝāƯz.have<z.nĆČƾvoLb=p.canEvolve?'ĀĂǉ:(p.lv<p.evoLvāĀĒ（需ĄĄƍoLĂĂǶ）':lćĖ˴ĂĀġ缺 '+lackċĀʄĉĀżname+'×'+(z.n-z.haveĊĕǐăĄҖĀĀƀćĀƝĬĥǇąĀƲĤāҋĆĀǶĨćӭ让ćķĒ化形？ĀģʧĄĀȘCočĒˎĒĀǻzċĄưĘĈępet.evolve',{ĖĀѫevoLbĘĉӸĎĜǍģĀӬreleaseĢĂŬconfirmďĀȫx.msgċĀǡyėĀŨĄĀņ:'1ĄėѶy&&yĉĀǭĐĂƷ,ĊĂǪ}},'放ĂŀőďĄЅĄčҞ,trip,feed,evo,ĈĀЯėāˡ化形材料：ĨĀ˥ '+zćĒӐČĀ˰+āăȫ后āļҜ1.3ćĜ˼ĎČƖmarketĄĚɯmarketĠĚɲshopģĚɳMarketĆĚІĎĚɮĄĀğdĊĥȩvar re=d.shopRe||{left:0,cost:0ĄļʹreĔĽʝČĉ˴e.left||m.ls<re.coąēѐ:ĄĀě?'换一批货，已买过的不会重复出现'āğı补货次数已用尽ĩĀӒshop.refreshđłťĄĀǭėēƢ)}},ĆĀƔ补货 ◆'+ĄĀƱ+'（余 '+rĆĐӧĀĂгāĀƥ已补ĆĽʿęĀȏĨĖˏnergyĈĀƽĊċѓenergy)ĈĒќĊĀĘĄċȤĂđɑĆœȍopĤļӰĀŉбĶēł每日换货 · 商队每日可请三次ĝēō囊中 ĊēŐĞņǓĄĂĄbottomĆĤӳeBtn,eēļĞĄĈȐd.shopĶĈȏsĄĀЌēĔʌsĔĘɏsčĘɏsĲĘɏsĆĘɏKINDN[s.k]||s.k}),s.ćłĽęŁʆĖĚƦ sbĘėпđĀʼ ĈĄɋĂēЏs.pricăĄɆ余 '+s.leftĥĔʖsĉāȘĄĀŊĨāĨbuy',{idx:s.idx}ĵāǯ'买'ćĥɳ;
var a=d.ĄĎǓs||{open:[],mine:[],ended:[ĊĴзitemAttrćďЅĄĤǑit.stċŜǾit.st)o.push(ċĘ҃'+itĄĘќĄĀļaf)it.afďĄȽf){ąĀŃf.n||ĆĘɦ||fĈĊиğĘɭĄĚǃit.rns&&it.rnĆĆʅĄĀŢăĘ˥ĄĀĚĔĂșSTN[z]||zĊĂӺĆķǧąăɆoĉęУ:(ĄěŋčĴӊitemName(ićĜɩąěƦ(it.nĆŕŐ:'')+(itĄġӴitĊġӵit.rnąĀĘrn+'纹ĄĈȔĈĩЌeft(ĆŐбĊĎțend-(S.me.now||ćįǈćĀǗs>3600000ĉĀɣs/ĄĀĔ)ăĄɡ:čĔʑąĀĦ60000)ăĎȽĄŚƔsc=ċę˅escrow||{}).reducĈŔ˾t,ćęˎt+ąĔɏąĀĳ[k])||0)},ĄĎ˘aucĤĂČĀĘąķĂč出价托管Āĺӳ落槌由天道裁定，回来即自动结算ĭĂĔ+(esc?'　托管ĆĀėesc)ąĽѽČĊӉĀďʉ'+(a.openTotal||a.opeĆĽĳĊĀĜ>ĊĀě?'，先列最先落槌的 '+ĊĀę+' 件':ĄŒРėġīċĀōĄĀčħġĩĘĹȈ ąĆӅČģĊtemċģďąĆӌĄĀět||0ČĺɒĆāŒx.itemąĖɵx.sellerĆāӆleft(x.endĝĜȅĄā˳ĄĀŏ})]ĒğʣĖŉŚĆĀ˺(x.top?'现价 '+x.top.amtāđƍ '+x.min)+' '}),x.myBidēŉȭ'+(x.top&&ĆĀŃ>ąĀİ'red':'goldĆĪǗ我出 '+ĄĀĠęĀĺ · 已被超ăĽǺ领先ĊĚƒĲĉѕamtĉĜǌ出价（不低于ĆĀƽ?Math.ceil(ĆĀƋ*1.05):ąĀȊ）ĆĜǎģĀıēĜǯamtĖĔĿąĐ˒bid',{aid:x.aid,amtąčȿamt)đĔœėĂɵrĈĂɵ出价ąĂɶěĉņ空空如也。去ĀĈу把东西挂上ĂĈв),a.mineĈČʧĈāȇ我的拍品'ĕĚдĆāƮmineģĺľĔāĵ(x.settled?ćĀĊ.winner?'成交ĄāŘttledąăĦ（ĉĀēwnamĂĎ˦:'流拍'):x.ĄŅҪĀđŮ等待裁定'āā˒čāƏąĀТ' čāĪ 无人āĀɒ)+(x.claimed?' ✓ĄĊЀ})),a.endĆĆɤČĀȵ已落槌（我参与的）ğĀȺendeğĢІĥĀȻĆĀӇċĀɂĈĢЬmĄĢЩ你拍得ďĀɔ:'他人đĀė):'ĂĀɄ)}ĉăǘwon=[];(ĄĀǄėďēifćĀƑ&&ĆĀɑ&&ĥĀƮ&&!S.ĄşѲ[x.aid]){čĀđ=1;won.pushĆāуĄĒǯwonĢĦҐwon)},12ąĉūvs=d.vshop;var vcarĈŔǵs){vcĜŁЁĔĔȊĈĂК珍宝阁'ĉŊӞvs.lvđĄˀćĂБvs.lv?'会员专属货架ĀĖƗ更新，贵一些但保证有货':'VIP1（ąĔȇs.unlockAtăĖӒ）起开放ĂĊĨvs.stoćĆҎĔĄ˰ĆĀĦŇĄ˲ũĄ˗(vs.excl||[])ĆĚĮsĄĚƶĞŋѠ'独家ĆāǁǾĄТvshop.ŐĄШĚĂƲĄĀӫ今日货已售罄。':'在坊市点「āąғ」即可开始累计ąĀӍlv?null:ĆĖŊsĄĖҗčęćąē˔,shop,vcard,aucĐĆяarena + bossĄĆѕarenaĠĆєĄŏФěĆѕvar bċĖѧsđĠґrenderArenaĄĆѼ.arena,b?bĄħҰoss:null,'arđġȉArena(a,boss,sub,wxĔĬǏarďĬǏĄļҤćĬǍąĀĐćĬǋarăŐĒ],['wx','棋局ęĬǋwx')wxĉĬǋif(a)ĐĀƬ'ar'ĊĬǮarenaĎĬǬwxĆĬǬWuxąŠҫ,wxĬĤюĈāҙ论ğŊЏ余 '+aĆĆӄĞīҥĀņӍ '+mąĽ˔aăĄĥāņӟĉĀĖssĄĂ˙ĆĀđw+' 胜ĉĀĐl+' 负 · 点到为止，不伤根基ĚĄɍĩĿЍĝĊ˼},[p.nēĞѻćĐаRN10[p.r]}),p.paĖĄšp.pa==='xie'ąĄŕblueąĄŕPATHN[p.pa]ĈăŊĘĖЀćŌШp.pwăăģĀĽʫ'+p.arėĽҟČāЫaģĦȮrĎāǲ.fight',{uid:p.uēēиrĈĈЋrĐĊѸrđĦȱĄĩӇĔĩƠĈĀĸċāȰrĊāȰossĄčҾĀĀӝľďƞđĈƣaąĈĳıĀȽĊĈŮċĄȈĖĀǍ},āĈǱĂĈŐĆĀŀĂČˎćľɊboąĽǘw=bossĄľӑĭāȐĀľʟĚāȐĊľЏ（ĊľЭ）Ăĭʩ余 '+bossĚāȱĕČˋėľҰĜńǬĄĀĮdesc+' 伤害按自身境界折算威能，全服同榜。次日登录ĄňɊĘŎĂčęːĆĕ˸ęĆƃ我的ĂĴѳfmt(boss.mineĥċӶĆĀȧīĀчboss.attackĔĂɾũāżaĄąƥ.ĈāŸ出手ĒıЬĄāҭbossĄħțĆţє0ČċЖbėė˓ċħȩbČħȩmĲħȦćĐǄĖČЌbĝħȣfmt(b.d)ĉŁɯif(a.standings&&ĈĀČĵĿ˩ĀōŀĜĂʳĀĂċ· 前 20 名ĚĂȳćĀƊħĂȸćĀɸpĵĀɸ+(p.rank<=3?' r'+p.rankćİоĆĀŠġħҺp.n+(p.paĂćҲĈĂɋċĐǌĕĀʴp.ssăćыġĞҝ赛季末前十名获能量奖励（5/3/1），前百名获ĀĔģąŀјĚĥĩāŉф
var WXN=['金ĂŢ˒,'木ĂŢˏ,'土']ĎĎʔąăɀďăѾwxģĊˑArena(nullĄĨѽwx',ĄăѢwxĉĈǖwxDraw(ĆňӬĒĀĹĊĖƷwxTile(vąĚāst=S.wxĎęѻid:'wx'+iĄţ˃'wxt e'+v+(st.sel===i?' selĈıɆWXN[v]đđʥwxTap(i)}}ČĀƍap(ČĀƊvar d=st.dĄĸʴ.mode==='d'&&dąāѾĆĒ˨ĀĊʡ交卷，可先练习'ďĬőĆĀƬnull||ĆĀĎĈĬФćĀǏ){ĄĀċĈĀǢĄĕҬĆĀɩĊŒʐaĄĀĩ,ar=(a/6)|0,ac=a%6,br=(i/6)|0,bc=i%6;
ĉŤˡar-br)+ćĀďc-bc)!==1ĆĀƄđĀŴąĀȏvĆĪҼ>=d.movesĆĀȏ步数已尽čĀȉąĮǬwxSim(st.seed,ĆĀŊąēǱ[ar,ac,br,bc]ąĂҧ!res.okĆĀƗćŊǊ0=$('wx'+a);if(e0)e0đœƷelĄĒШe1ąĀıi);if(e1){e1ĐĀĲbadąĲǶe1ĊĲǵĊĀĮaddĄĀīĄČŋ'这一步不成连珠čĀǿąĀǩ=ĝĀǲ;ĉĀǤ
var fĈĀǥ,fČĀǀf0)f0ĎŠɌlrĄņЁ1)f1ēĀĝ
ēĆ˲ĆĀ˱},280ďīŚĉĄхąŚǾĈīŋwxĘīŋdėīŋ!S.wx||S.wx.day!==d.day)S.wx={day:d.day,seed:d.seed,moves:[],selĄłҟode:'d',d:d};
S.wx.d=d;čāǜėĀ҈ĄĲһone=ĆāǧįĪǴāāҴ'+ĉāȸp'?'（练习盘ĆĂş
ĘĂʌĀŋЦ生ĀŋТ生ĀŋОğĝƳĈŋѠ以上相生或同气即ĀĀѾ：相生 10×长²，同气 4āĀć连锁一次多算五成。āĀҝ的交换无效ĖīƍįĆʒĉĪǲČāȞ+'/'+Ąāȡ+' 步'ğăđres.scoreĄĊƲĝě˝连珠 '+res.chainăąȦ最长ĄĀēmĄŒǌĎĀǨwxg'},resĈĪѳwxTile)ĭīʤ[
ĊĂģĔĎĳĈăӅdone||!ČĀȪĚĎĺČĀī<ĄĀɒ&&ċĎœ还ĂŎӕĄĀĜ-ČĀĴ)+'Āı˦就此交卷？ęĨĪwx.submit',{moves:ąĀŇőĭӂĆĮǸąĆ˄wxresĆŋщwxres.drops)ĦĐŅ;S.wxĆĈƒĥĮȒĝĂӶČīҧĝĀĮ},done?ăĂО':'ĀĀĄĜĘɖĒĘʴĐāЀċĀѭ('wxp:'+ĈċȸĜāТċĀĿ'p'ćāдćāӿ},ČĀĦĀāʾ':'回到今日ĖĨӆĊćїċĀѻ&&ĊĀŎıĀǫpĸĀǫĚĀǝp'āĎĞ盘':'重来')]),
d.mineĲĬɁĂĀˮĄąǞd.mine.scăāˉ+(d.rank?'，第 '+d.rank+' 名ĄĂĕ:İĀůfmt(d.tiers[0]ĂĀŧ起给ĀċЗąĀƀtiers[1ăĀę加ĀĐɊċĀĘ2ăĀĘ另赠悟性ĆĄƐĭĂǮ今日棋榜ĚńɉĊĬˣdǈĬˣfmt(xĆĀ˞ġĬˤĀğˌĀĬˤ落子ēĬˣĎĄ˾secąďƹsecĢďƷėđӘČĄ˥SecĘďƵSecđďƳĉĈǿsectĉĈǾsect'ĄĈſd.secĄčʦs=d.sectĄŇѳLeader=s.myRole==='掌门'ĭĆѶĖŏТćăňs.level+' 级 · '+s.memberCount+' 人'ğŏѡesc||'（无宗旨）ĤŐѰĀĀǋďņǍs.leaderNĆĀƳbćċɌĒĀįmyRolăĉ˓贡献 '+s.myPtsčĀļ宗门加持đņҞĀĞɍ+'+s.buffđņѐ入门要求ĐĀķRN[s.req]+'以上'ĥďıĝćЇįČƮ捐献ĀĠѣ1āŏʳ = 1ĀĀȁ）','100'įČťsect.donate',{ĠČśSecĞČř捐献'),s.wage&&s.wage.lv>0?ğĘӧĄĀĭtakenĨćǁsect.wageđĈąĠĀƲĉĀŶ?'俸禄已领':'领俸禄 '+ĄĀĚamounĄŎё,!ąāƧ?Ņīʯ退出宗门？贡献清零，一日内各宗不收ĚĠћsectĄīʰĎň˵secĄģɦ退出ĈĦƳąĵҏsbossĮćģ宗门试炼ěćĤĄĀřĊņӝāğʃ 2Ġĉˣ伤害计入ĀŐɮ全宗周ĂŔƟ,ĵĕȫďĀȤĔĊȝšćӓĈĀʌĆćӃĬğʤćĀɔĉćӛ1ĭćӛŹćҲ;
if(s.costıĀѶ建设Ĝćқ库藏ąŖˣ.treasury)+'āĂĕ· 已用ĆĀěspenĒœӆĄăƆĄĀơĎōŪ
ķĊǲĉĂőbąĂʏğĩſ●āĀĀćĚĳb.lv)+'○āĀĀĉĀĕmax-b.lvĝĲŞbĆŉҲ,
b.costĄćŭğČǈāĠӚ}đĨȤs.canBuild&&ćĀɶ>=b.costČĝƉĉČŋąĀĶ||ćĀĶ<b.costĨāЫ动用 '+bĄĒĔ 库藏，把'+bĄāɳ修到 '+(b.lv+1)+' 级ęŊɍĄāȢuild',{b:b.kąāț||!ĄĂŁĈŃӛğăɈěĂŰ(f&&f.data)||ĉĂȰ升级ĆĀǑĠĈȵćĀɇ?Āăŏ与长老可动用库藏。Āāĉ= 全宗ĀĀӹ-ĀĀӹ。'āāě由ĂĀğ支配。你的每一次捐献都算ĀıʩĆĄǊif(s.wkĮāƖāŒȄĜāƖăČѩwkĊŉƄ · 达成几条，下周一并发赏ČőŐ[['don'āĂн贡献'],['sb','试炼Āāз],['awĂČĬ胜场ĎĭȈgĄŀвur=s.wk.cur[gĄňĶ,need=s.wk.goalsąĀĘ1ďēʹĔğӓġāǹtext:g[1]ğāНcurąĿȖfmt(ĆĖʍıĢľ(cur,ĄŘȱĄęѺĞĀм(s.last?'上周达成 '+s.lastąŏЌ3ăŎɚ+ĀĀĝ出过力的人ĀŒӯ登录时自动ąĊ˨İĄӿ门人ĘĄӽąĄŴsňČŪėČĶrćĄɐ?'gold':ćĀĔ长老'?'Ąř˭ćĉĲp.role}),ĖČǀĉĀɜĆČǂ+'ĉŘѾćČŕĂĄƬp.pts})]),ąăɆĆĎӕp.uid)!čĊăĊĐфċĀƲħĆȬmg('dismiss',p.uid)}},'免ĀĀŅ)ĝĬЏČĀņappointĉĀņ任āĀņıĪƷĉāә传位给 '+p.n+'？'))mg('transferĉĀū传位ĕĀŪĢăѹĉĀű逐出čĀŰbanĉĀū逐出ĆŝȎĊĂӒąĀʺĮāм掌门事务ĘĖӬıĔƾrĉĄМ入门最低境界（0 炼气 … 8 渡劫ćĐҫs.reqēĐҋrĄğƿ)mg('setReq',null,{reqąĄЕrĄăˋĂąĠĳĚșĊĄӉ宗旨（80 字内）',ĆąɎĄĉģČĀƏDescąĀƐdesc:t}ăōӊ宗旨ņĀЌ解散ĀĄʄ不可恢复。ĄĀЋdisband')}},ĀĀĝĆČОČĊѓmg(action,uid,extrĄĩ˺pčĨƌaction:action},uidĆğжuidĊŨʥ{uid:uid}:{},extraćŤЭďĂӄmanage',pĖĄЏćĘĦĚŗĳ宗门名đŘʽ}),descėĀĶ旨（可空ċĀĲ0})Įčĭ你是ĀőӉĝĄЭ加入宗门可获Āŕƕ持与āĄҗ；金丹之āŕǆ'+dąăȓăŕǌĂĄъm.r>=2?ĞĹƃ[nameĎĢʱĄňɲ6px'ĄĀȁĖŖЫĔćʆĈĹӳls<dĜă˫ēĀ˜ĜŘʐ,desc:desc.valąĄӟēąȓāĀȗĈāːįıʲ'诸宗ĚćˍĉĶˈdĐĎхsĹĂ˚sĘĭ˄ċăСēĆӛs+' 人 · 掌门ĄĐȈąĆѵ+' · ăĺȇs.req]ĥĆӻ'})]),!m.sectĶįɖďĀ˲join',{sid:s.sđŎ˝ćĀ˓拜入ĈŖѲěćѠ天下尚无ĀŖǝ第一个开宗Āăǝ会被记住ĤćѫleaderboardąĐǗlbďćѱlbLoad(ĄŜӵ)}ĎāЫĄĀĠtypeĐćҟlbąĆӃtypeĞĐȈĉćѯlběĩʩēıʛĄŝƝ'境界ĎŌʜċŠƶ],['season',ĀČҶ'],['wealth','财富ČŠǒ],['xian','仙籍Īıʹ(ĄũȕćıʻĄăґĔăƎąĀɏČıǎčŚˢ.lb)];ċĀˡvar LBSEAL=['','壹','貳','叁ĊħǼlbVaĉŧǄąŨĮ.vĉũʻfmt(r.v)ąĆŌr.vĄŠǥop three as an ink-mountain podium: first centred and raised inside a gold ring, second 青玉, third 赤铜ĈŠǷpodium(toĄŬҋđũЁpodiumċĩШgate(x,top,w,hh,col,lit,glypĄŁяl=x-w/2,r=x+w/2,b=top+hhąčƝĈţӒ'+(l-7)+' '+(top+12)+' LąŤǗ(top-7ĄĀĒ(r+ĎĀĪĆŢɹ'+col+'Čšәĉţɴ'+(l-4ĉĀŀ0ďĀū2ćĀūĎĀĪēŞɠ'+lit+'ĒŢ˂rect x="'+l+'" y="ċĀŏĄĀī'+w+'" ĄŰŜ"'+(hh-ĊĀŲ#0d152ĈŤǫĆĀǮčšҮ4ċĀŷ(l+5)ČĀŻ5ċĀŻ(wąĀūċĀƀ2ęĀǳċĀŽĈŢў5Ďşǅ7ĎĀʅ+5ĈĀɚ44)+' H'+(r-5)ćĀŔęĀťčŢĄ'+x+'" cćĀǤ30)+'" r="12čĀТıĀĻħĀ˳texĄĀɻxċĀɷ35)+'" font-family="STKaiti,KaiTi,serifĄĀġsizeĉţӾ#1d1607" text-anchor="middle">'+glyph+'</textħĀǠ7ģĀǠćĀɺ4đşȟ2 4"/>'}
boxěŠȠ360 170ĒŠȢ<defs>ċŦūcl" x="-20%" y="-60%ĆĀһ140%ćĀҵ220%"><feGaussianBlur stdDeviation="5ĉŦĤēŦЪltŎŦЪ6ĥŦɾġŦЩąŦǖČŠũ18ąţĈ6" r="54čŤƓtĆŠЫĈŦČ170 L30 136 L62 122 L96 140 L130 17ĈŦĖ131d2ċťɍ23ĄĀń262 142 L300 126 L330 146 LĄĀ˴ĚĀŇ96 170 L136 126 L158ĄĀƅ80 100 L206 136 L228 146 L266ČĀŘa2633ąĀǧgčŤБclĊŤʖ6"ĈŤɡĈţɋ151" rx="62" ry="Ćāĥ#3a4a5a"/ċĀĸ30ĵĀĹĆĀʶĆĀĹ70" ry="6ĐĀĹ/g>'+
gate(60,50,74,98,'#5fa37a','#bfe6c8ĂĂҡ)+gate(300,60,74,88,'#c2734a','#f2c29aĂĂӈĄĀĪ180,20,76,128,Ćňˡ,Ćň˵,'壹')+
'ĆŠ˖var podsđĂлs'});
[[1,'p2'],[0,'p1'],[2,'p3']]Ēĕˑvar r=top[x[0]ĄŠȼpm=[ąăš===Ąľʄ?null:ĄĀČ,r.pa?PATHN[r.pa]:null,r.titleĆŗЙBooleanĊĲǿ;
podsěĢȍod '+x[1]ĒĘőlĄĄĹLBSEAL[r.rank]||ĆăǦĈČĩċĀŗnąĥ҄r.nĆĮǺ}),pmĎČиpv pĆĥҳpmĄćŹmĕĖȇpąķЭąĀȸĆŢӿčŬ˝poĈŵžboxĉĘѲbRow(r,meĜČɜmeĆćƝrčđơĦČɞ+ĄĀȩĆđƢrēđƢrĜČɹ},[rĄćʈąĀЪĚąĈĄĀĤąĀɉręēіrĢēіrĉēіrĦšȹrĊšȹ,rąšʫĘĥɸsubĊŕӪĕĈɕĉĀЅĊĀˠCard(lb){if(!lbČĠȻĈīƋlb.rows||ĄĸˆmeĄŞŨĈĄѣĊąЃĝĒİ共 '+(lb.total||rowĉĎѤ人'})ĄāǾrest=rows;
if(ĈĀħ>=3ĉĻąĄĄǕrowćŚű3)));ĆĀŀĄĀĖ3ĄĄ˗pin=!!(lb.me&&!rows.someđįЄĔĀӝlbąčȿ}ěĈ˷ĄąӻreėįѧĈāŭ})ąġҤinĘćмnote pin'},[lbRow(lb.me,me)])Ğġɽēą˃道册（ĀŘ˼/ 成就 / 传记）ąķťioďąˈbioLoad(ąŘӝ||ąŘӞĐą˔ąĀĬsubĈřďsubĄėȒĈąˢąĴɥch'?'ach'ĄĶҫ'life'?'bioĆĀĒcodex'?ĄĀć:ąĀƀĠĖġąśĽĊşĶvar navėķƨąĀş'ĀřƲ],['ach','成就'],[ĄĀƄ,'图鉴'],['life',āŝʌŊķƗĐĀʁēĶҩĉąӺbio'ċĕәąĀʪĎđƂąĀĘĒđƆćĀčbountyąļƬounty,nav));ďĵįch'ĈĀŇachĄĀĶachĄĀĳĎıĎodexĉĀĴcodexĄĀĶcodexĊĀĸĎĀǪĖĆǦnav]ćĥȮlifeCards(d,mĘŁǌĈĀǬb,naĄĭŏbĕĤǰĊĀŬćŰ˂ćāюbēľĮĄğŉb=ćęĞğċʂ领ēċʁxĄĽҺĔċɩx.doneĪĔЁunty.claim',{i:xēģјİČг
ąŇӹĕČЧąĀӧĉāɟďŇ˖bountyČĀĎ.allClaimedĈŚєĎŚѐin,950ċŃǁċĀŝćŀȤĆĀčąĂưĄĐГĉĀĚ,finĄėŞfin(ăŚ˦取'ėāҕtut'+(xĩŞКxĐŞКĕĢśĆČɦxġł˒xĎŁҗĨċűx.cur,x.ĊċŵĜĀŮcurĄċǱx.need+' · 赏 '+xąĨȑ与一件ĀŮ˄})]),lab]Ćħūtail=bĈĀ˥āđį三赏皆结，悟性已 +1。已连续 '+b.sąřлĀŃƗ:'āŞā：ĂŞĂ；ĂŞĂ一只宝匣（还差 '+b.allReward.chestIn+' 日ĀĨɲ;
Ěęʖnav,ċăă悬ċċӀđė˩ '+b.doneN+'/'+Ąăď+' · ĎĀƷČČčrowsĖĀɗęŞҹtail}ĉğʙcard}
// 百科图鉴：物品按类、妖兽一类。纯静态数据，只拉一次。ĉŒżąā҈cxćāЊcxģāЋvar kind=S.cxKind||'pill';ĎćʉąĀˡkbĔĂʎcx.kinėŘҌďāГkind===kĢĂɜąĀơ=k[0]ćāʂĄĂƙ}},kĊĂɭrows;if(ĄĀţ'mon'){rows=cx.mĎŃӓąĘШm=x.m||{};ĘĄɣąĀˏĉŤɟflex-startđĖӖx.id,xĄĖӌicđĂȒĎģɺĈģɭx.tĆĿʽ' ',xĊĿŊxĉĿŊx.bossĝťҏ'头目ĤŚƖxĕęӬĊĉƦ出没：'+(xĄĢʼ||'—Ąĳơ血 ×'+(mm.hp||1)+' 攻ąĀđatkĄĀĒ防ąĀĒdefĄĀĒ速ąĀĒspd||1)}),xěŀŏĊĀƏ掉落ăĽǱęłȋėłǃ' '+d.ĄģУĐśʛ]ĆļҎĆĀёitemsĘłŔx.k===kind}ďĩŔvar exĄĞ˽xĎĞ˼x.st)exđĞ˼+'+xĈĞ˼x.slot)ex.unshift(SLOTN[x.slot]||ĄĀĠ;if(x.pećĀŖxĉŗǥăĝǢąŗȂ+' · 攻ċĪȴx.pet.atkĆŌɛ血đĀĠĈŌЀĄĀųfxĈĀŲfx)ęīғĠāŧĘŀˬĴāşĜĔƜ　售ĄčĢx.vğšӴĆāļexġĀҶexċĸЋĊĀѮğāӐČĂǯĀĄǷěĂǯĀĲĘ所录：'+ĆĀҾćĞƿ物品，'+ąāШĆĀĖ种妖兽'}),kbĦĐĕ8px'},ĈąȦ?rows:ěĦĂ此卷尚空ăčҽċįȸĄĄƨaćĂǧaĨăӲtbtns=ĐČҮa.cur?'sm'ıĐʴach.titlĄĥӦnullċĊӺĆĂƪach'ăĽƷ用称号'ćĄǵa.titleĨŇȊa.ĄŇȌĄĆǍĤļıĝĀƻtĎıӱĎĀƻĄĀű)}ğąˑĐĀґĀąƘěĀґ已成 '+aĄĎ˛ / '+aĄăƂ(ĄĀʥ · 当前称号 '+a.curćėӞĈĝʘĀĀɝĖčʮtbtnsĝĶĲĄĀʏąğǨ佩戴后显示在顶栏你的名字旁，以及各榜单你那一行。'āĦҭ称号。下面带紫色标签的成就，达成即可佩戴。ĬĚҨxĽĐʶďĚҡĈĄƼgolĉųǂĎĄƧxĤČƣxćĐʘĊĎ˞xĦćœxċćœx.lsęĿІxĈĵӛąĀıwuĔąƃreeĆĩʘāĄŉ'+x.wu}čĺӂĉŊǏĉąɬąĘıdĈŪȏ
ĈĶʼġŤɪname+'传ĨŚЦĀńҡĐēȬt.fights+' 场，胜 '+st.winĎēȬĆňŏēŚʦĄŇƂsĎŚʫ突破ēĀŵbtĂŞǋ失败 '+st.btFaiĎŚɷĀį˗ęĀŴtribďĀűĀĽЙęĀĴcraftďĀĵĒŚň(ĉŤʔąŤˢĔŚőĦŤơ年谱ěĔӰioĎđѧvar dt=new Date(b.tďĲѱĒąȰĈāŒdt.getMonth()+1+'/'+dt.getDate(ąĠǁb.vąČȣĆĀǽhistorĉŤҤĄĀđĕĂѨēĀǹ前世ěčМċĀŚĥřмĉăɆcausćĀčagăşѫĄğţ:null]}
